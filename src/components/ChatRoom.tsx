...
const handleSendMessage = async (messageText?: string) => {
  ...
  console.log('Sending new message:', newMessage); // Add this line to log the message being sent
...
const handleReply = (messageId: string) => {
  ...
  if (messageToReply) {
    console.log('Setting replied message:', messageToReply); // Add this line
